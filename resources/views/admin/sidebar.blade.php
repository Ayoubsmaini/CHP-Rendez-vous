<aside class="sidenav navbar navbar-vertical navbar-expand-xs border-0 border-radius-xl my-3 fixed-start ms-3 " id="sidenav-main">
    <div class="sidenav-header mb-2">
      ...
      <a class="navbar-brand d-flex justify-center m-0" href="{{ url('home') }}" target="_blank">
        <img src="assests/img/icon.png"  style="min-height: 3.5rem;" alt="main_logo">
      </a>
    </div>
    ...
    <div class=" navbar-collapse  w-auto " style="height: 500px;" id="sidenav-collapse-main">
      ...
      <li class="nav-item">
          <a class="nav-link  active" href="{{url('showadoctors')}}" >
            <div class="icon icon-shape icon-sm shadow border-radius-md bg-white text-center me-2 d-flex align-items-center justify-content-center" style=" background-image: linear-gradient(310deg, #239447 0%, #239447 100%);">
